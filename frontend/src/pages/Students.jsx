...
import { setModalShow, setTypeModal } from "../store/studentSlice.js";
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <h3 className="text-xl font-semibold">Students Management</h3>
        <button
                ...
                <tr key={student._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <div className="flex space-x-2">
                      ...
                      <button
                        onClick={() => deleteStudent.mutate(student._id)}
